...
import net.general.aggregation.utils.AgentUserKit;
import net.general.aggregation.utils.IpAddressUtil;
...
public class SysLogAspect {
    ...
    //定义切点 @Pointcut
    //在注解的位置切入代码
    @Pointcut("@annotation( net.general.aggregation.config.MyLog)")
...
//        String agent = request.getHeader("user-agent");
        ...
        System.out.println("设备信息为===>>" + deviceInfo);
