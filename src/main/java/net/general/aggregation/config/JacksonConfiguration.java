...
public class JacksonConfiguration {
     ...
     */
    @Bean
    public Converter<String, LocalDate> localTimeConverter() {
        return new Converter<String, LocalDate>() {
            @Override
            public LocalDate convert(String time) {
                return LocalDate.parse(time, DateTimeFormatter.ofPattern(DEFAULT_TIME_FORMAT));
            }
        };
    }
    ...
    public Converter<String, LocalDate> localDateTimeConverter() {
        return new Converter<String, LocalDate>() {
            @Override
            public LocalDate convert(String time) {
                return LocalDate.parse(time, DateTimeFormatter.ofPattern(DEFAULT_DATE_TIME_FORMAT));
            }
        };
    }
